...
<!-- Mirrored from p.w3layouts.com/demos/19-02-2016/around/web/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 07:34:28 GMT -->
	...
	<div class="contact">
		<div class="container">
			<div class="contact-heading">
					...
					<p class="wow fadeInUp animated" data-wow-delay=".5s">Connecting Your Queries to Solutions, One Call or Click Away!"</p>
				</div>
				<!---728x90--->
			...
			<div class="address">
				<div class="col-md-4 address-grids wow fadeInLeft animated" data-wow-delay=".5s">
					<h4>Address :</h4>
					<ul>
						<li style="color:grey; font-weight: 500"><p style="color:grey"> GROUND FLOOR, PLOT NO-6-A/1,


            <br>
            KH NO. 846 & 847, SHYAM VIHAR, PHASE-1,<br>B-BLOCK, NAJAFGARH, New Delhi, South West Delhi, Delhi, 110043</p>
                        </li>
					</ul>
				</div>
				...
				<div class="col-md-4 address-grids wow fadeInRight animated" data-wow-delay=".5s">
					<h4>Email :</h4>
          <p><a href="#"><span>Ops@globalconnect.net.in</span></a></p>
					<p><a href="#"><span>vikas@globalconnect.net.in</span></a></p>
			...
			<div class="contact-form wow fadeInUp animated" data-wow-delay=".5s">
				...
				<form method="post" action="#">
					...
					<button type="submit" name="submit" class="btn1 btn-1 btn-1b" value="send">Submit</button>
				</form>
			</div>	
		</div>
	</div>
