...
<div id="wrapper">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              while($row = mysqli_fetch_assoc($result)){
                ...
                <td><a href='?id=<?php echo $row['id']?>'> <button class="btn">Delete</button> </a> &nbsp; 
    ...
    <!-- <div class="copy_layout">
      <p>Copyright © 2015 Modern. All Rights Reserved | Design by <a href="#" target="_blank">GWPL</a> </p>
   </div> -->
   </div>
      </div>
      <!-- /#page-wrapper -->
